- [SpringSecurity权限控制](#springsecurity权限控制)
  - [1.1 Security配置](#11-security配置)
    - [1.1.1 基本配置](#111-基本配置)
    - [1.1.2 跨域](#112-跨域)
  - [1.2 从数据库查询](#12-从数据库查询)
    - [1.2.1 查询用户](#121-查询用户)
    - [1.2.2 返回类](#122-返回类)
  - [1.3 实现登录接口](#13-实现登录接口)
  - [1.4 配置认证过滤器](#14-配置认证过滤器)
  - [1.5 配置失败处理](#15-配置失败处理)
...
- [统一结果返回类](#统一结果返回类)
  ...
  - [2 枚举结果](#2-枚举结果)
- [工具类](#工具类)
  - [1 Redis封装工具类](#1-redis封装工具类)
  - [2 FastJson序列化工具类](#2-fastjson序列化工具类)
  - [3 JWT工具类](#3-jwt工具类)
  - [4 响应前端工具类](#4-响应前端工具类)
...
```java
package cn.zzw.webspring.domain.result;
...
```java
package cn.zzw.webspring.utils;
